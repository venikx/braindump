#+TITLE: Handmade Hero
WARNING: Deprecated! Why? Ever since reading [[file:references/ahrens2017how.org][How to take smart notes]] I consider these notes as fleeting notes and should be either converted into permanent notes.
Or should be thrown away if I can't turn them into permanent notes.

I still want to keep these "fleeting notes" for now, as I never really had the time to properly go over these and I'm not willing to thrown them away without a proper review.
These notes probably can be turned into journal entries or something to highlight what I learned or whatever.
